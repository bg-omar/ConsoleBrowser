...
import com.github.bgomar.consolebrowser.ConsoleBrowserBundle
...
class GZoomOutAction(private val jbCefBrowser: JBCefBrowser, icon: Icon) :
  AnAction(ConsoleBrowserBundle.message("actions.zoom.out.text"), "", icon), DumbAware {
...
class GZoomInAction(private val jbCefBrowser: JBCefBrowser, icon: Icon) :
  AnAction(ConsoleBrowserBundle.message("actions.zoom.in.text"), "", icon), DumbAware {
